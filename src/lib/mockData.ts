...
export interface GalleryItem {
  ...
  image: string;
  category: 'events' | 'development' | 'culture' | 'nature' | 'celebrities' | 'festival';
  villageId: string;
  date: string;
  photographer?: string;
  tags: string[];
...
export const mockGallery: GalleryItem[] = [
  {
    ...
    description: 'Flag hoisting and cultural programs at village ground',
    descriptionHi: 'गाँव के मैदान में ध्वजारोहण और सांस्कृतिक कार्यक्रम',
    descriptionGu: 'ગામના મેદાનમાં ધ્વજવંદન અને સાંસ્કૃતિક કાર્યક્રમો',
    image: 'https://images.unsplash.com/photo-1532375810709-75b1da00537c?w=600&h=400&fit=crop',
    category: 'events',
    villageId: 'dungarpur',
    date: '2024-08-15',
    tags: ['patriotic', 'national', 'celebration'],
  },
  {
    id: '2',
    ...
    description: 'Ancient temple at the heart of our village',
    descriptionHi: 'हमारे गाँव के केंद्र में प्राचीन मंदिर',
    descriptionGu: 'અમારા ગામના કેન્દ્રમાં પ્રાચીન મંદિર',
  ...
  },
  {
    ...
    description: 'New road construction under development scheme',
    descriptionHi: 'विकास योजना के तहत नई सड़क निर्माण',
    descriptionGu: 'વિકાસ યોજના હેઠળ નવા રસ્તાનું બાંધકામ',
    image: 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=600&h=400&fit=crop',
    category: 'development',
    villageId: 'dungarpur',
    date: '2024-09-15',
    tags: ['infrastructure', 'progress', 'construction'],
  },
  {
    id: '4',
    ...
    description: 'Beautiful sunset view at the village lake',
    descriptionHi: 'गाँव की झील पर खूबसूरत सूर्यास्त का दृश्य',
    descriptionGu: 'ગામના તળાવ પર સુંદર સૂર્યાસ્તનો નજારો',
    image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&h=400&fit=crop',
    category: 'nature',
    villageId: 'dungarpur',
    date: '2024-10-20',
    tags: ['scenic', 'lake', 'sunset'],
  },
  {
    id: '5',
    ...
    description: 'Honorable minister visiting our village for inauguration',
    descriptionHi: 'माननीय मंत्री जी का उद्घाटन के लिए गाँव में दौरा',
    descriptionGu: 'માનનીય મંત્રીજીની ઉદ્ઘાટન માટે ગામની મુલાકાત',
    image: 'https://images.unsplash.com/photo-1529107386315-e1a2ed48a620?w=600&h=400&fit=crop',
    category: 'celebrities',
    villageId: 'dungarpur',
    date: '2024-07-10',
    tags: ['VIP', 'government', 'inauguration'],
  },
  {
    id: '6',
    ...
    titleHi: 'होली उत्सव',
    titleGu: 'હોળી ઉત્સવ',
    description: 'Colorful Holi festival celebration in village',
    descriptionHi: 'गाँव में रंगीन होली त्योहार का जश्न',
    descriptionGu: 'ગામમાં રંગબેરંગી હોળી ઉત્સવની ઉજવણી',
    image: 'https://images.unsplash.com/photo-1576398289164-c48dc021b4e1?w=600&h=400&fit=crop',
    category: 'festival',
    villageId: 'dungarpur',
    date: '2024-03-25',
    tags: ['holi', 'colors', 'celebration'],
  },
  {
    id: '7',
    title: 'Diwali Night',
    titleHi: 'दीपावली की रात',
    titleGu: 'દિવાળીની રાત',
    description: 'Village lit up with thousands of diyas on Diwali',
    descriptionHi: 'दीपावली पर हजारों दीयों से जगमगाता गाँव',
    descriptionGu: 'દિવાળી પર હજારો દીવાઓથી ઝગમગતું ગામ',
    image: 'https://images.unsplash.com/photo-1605196560547-b60f7e5c0de7?w=600&h=400&fit=crop',
    category: 'festival',
    villageId: 'dungarpur',
    date: '2024-11-01',
  ...
  },
  {
    ...
    titleHi: 'नवरात्रि गरबा',
    titleGu: 'નવરાત્રિ ગરબા',
    description: 'Traditional Garba dance during Navratri festival',
    descriptionHi: 'नवरात्रि उत्सव के दौरान पारंपरिक गरबा नृत्य',
    descriptionGu: 'નવરાત્રિ ઉત્સવ દરમિયાન પરંપરાગત ગરબા નૃત્ય',
    image: 'https://images.unsplash.com/photo-1601901661780-a57c0b9cebde?w=600&h=400&fit=crop',
    category: 'festival',
    villageId: 'dungarpur',
    date: '2024-10-10',
    tags: ['navratri', 'garba', 'dance'],
  },
  {
    id: '9',
    title: 'Village School Function',
    titleHi: 'गाँव के स्कूल का कार्यक्रम',
    titleGu: 'ગામની શાળાનો કાર્યક્રમ',
    description: 'Annual day celebration at village primary school',
    descriptionHi: 'गाँव के प्राथमिक विद्यालय में वार्षिक दिवस समारोह',
    descriptionGu: 'ગામની પ્રાથમિક શાળામાં વાર્ષિક દિવસ ઉજવણી',
    image: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=600&h=400&fit=crop',
    category: 'events',
    villageId: 'dungarpur',
    date: '2024-02-28',
    tags: ['school', 'education', 'children'],
  },
  {
    id: '10',
    title: 'Traditional Folk Dance',
    titleHi: 'पारंपरिक लोक नृत्य',
    titleGu: 'પરંપરાગત લોક નૃત્ય',
    description: 'Local artists performing traditional folk dance',
    descriptionHi: 'स्थानीय कलाकारों द्वारा पारंपरिक लोक नृत्य प्रदर्शन',
    descriptionGu: 'સ્થાનિક કલાકારો દ્વારા પરંપરાગત લોક નૃત્ય પ્રદર્શન',
    image: 'https://images.unsplash.com/photo-1504609813442-a8924e83f76e?w=600&h=400&fit=crop',
    category: 'culture',
    villageId: 'dungarpur',
    date: '2024-04-15',
    tags: ['dance', 'tradition', 'arts'],
  },
  {
    id: '11',
    title: 'Water Tank Inauguration',
    titleHi: 'पानी की टंकी का उद्घाटन',
    titleGu: 'પાણીની ટાંકીનું ઉદ્ઘાટન',
    description: 'New overhead water tank inaugurated for village',
    descriptionHi: 'गाँव के लिए नई ओवरहेड पानी की टंकी का उद्घाटन',
    descriptionGu: 'ગામ માટે નવી ઓવરહેડ પાણીની ટાંકીનું ઉદ્ઘાટન',
    image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&h=400&fit=crop',
    category: 'development',
    villageId: 'dungarpur',
    date: '2024-05-20',
    tags: ['water', 'infrastructure', 'development'],
  },
  {
    id: '12',
    title: 'Green Fields',
    titleHi: 'हरे-भरे खेत',
    titleGu: 'લીલાછમ ખેતરો',
    description: 'Lush green agricultural fields after monsoon',
    descriptionHi: 'मानसून के बाद हरे-भरे कृषि खेत',
    descriptionGu: 'ચોમાસા પછી લીલાછમ ખેતીના ખેતરો',
    image: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=600&h=400&fit=crop',
    category: 'nature',
    villageId: 'dungarpur',
    date: '2024-08-01',
    tags: ['agriculture', 'farming', 'green'],
  },
  {
    id: '13',
    title: 'Makar Sankranti Kite Festival',
    titleHi: 'मकर संक्रांति पतंग उत्सव',
    titleGu: 'ઉત્તરાયણ પતંગ ઉત્સવ',
    description: 'Colorful kites flying high during Uttarayan',
    descriptionHi: 'उत्तरायण के दौरान आसमान में उड़ती रंग-बिरंगी पतंगें',
    descriptionGu: 'ઉત્તરાયણ દરમિયાન આકાશમાં ઊડતી રંગબેરંગી પતંગો',
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&h=400&fit=crop',
    category: 'festival',
    villageId: 'dungarpur',
    date: '2024-01-14',
    tags: ['kites', 'uttarayan', 'festival'],
  },
  {
    id: '14',
    title: 'Village Heritage Well',
    titleHi: 'गाँव की ऐतिहासिक बावड़ी',
    titleGu: 'ગામની ઐતિહાસિક વાવ',
    description: 'Ancient stepwell preserved as heritage site',
    descriptionHi: 'विरासत स्थल के रूप में संरक्षित प्राचीन बावड़ी',
    descriptionGu: 'વારસા સ્થળ તરીકે સાચવેલ પ્રાચીન વાવ',
  ...
  },
  {
    ...
    titleHi: 'जन्माष्टमी उत्सव',
    titleGu: 'જન્માષ્ટમી ઉત્સવ',
    description: 'Dahi Handi and Krishna Janmashtami celebrations',
    descriptionHi: 'दही हांडी और कृष्ण जन्माष्टमी का जश्न',
    descriptionGu: 'દહીં હાંડી અને કૃષ્ણ જન્માષ્ટમીની ઉજવણી',
    image: 'https://images.unsplash.com/photo-1567591370504-80f7a4e4d0d0?w=600&h=400&fit=crop',
    category: 'festival',
    villageId: 'dungarpur',
    date: '2024-08-26',
